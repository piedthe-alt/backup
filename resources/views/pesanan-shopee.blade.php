...
<body>
    ...
    <script>
        ...
        function addProductRow() {
            ...
            row.innerHTML = `
                <div class="product-select">
                    <select class="form-select" onchange="updateProductPrice(${productRowCount})" required>
        ...
        async function showDetail(pesananId) {
            ...
            try {
                const response = await fetch(`/pesanan-shopee/detail/${pesananId}`);
                const data = await response.json();
                    ...
                    <div class="pesanan-detail-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    ...
                                    <div class="info-value">${pesanan.nama_pembeli || '-'}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item mb-3">
                                    ...
                                    <div class="info-value">
                                        <span class="jenis-badge jenis-${pesanan.jenis.toLowerCase()}">${pesanan.jenis}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="detail-summary">
                            <div class="summary-row">
                                ...
                                <span>Rp ${numberFormat(pesanan.total_harga_jual)}</span>
                            </div>
                        </div>
                    </div>
                `;
        ...
        async function updateStatus() {
            ...
            try {
                const response = await fetch(`/pesanan-shopee/update-status/${currentPesananId}`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
                    }
